    ...
    const eras = [
        {
            ...
            image: <img src="/history/historical-okinawa-photo.jpg" alt="Okinawa Map" className="w-auto h-full" />,
        ...
        },
        {
            ...
            image: <img src="/history/gichin-funakoshi.jpg" alt="Gichin Funakoshi Portrait" className="w-auto h-full" />,
        ...
        },
        {
            ...
            image: <img src="/history/first-shotokan-dojo.jpg" alt="First Shotokan Dojo" className="w-auto h-full" />,
        ...
        },
        {
            ...
            image: <img src="/history/kata-demonstration.jpg" alt="Kata Demonstration" className="w-auto h-full" />,
        ...
        },
        {
            ...
            image: <img src="/history/international-training.jpg" alt="International Training" className="w-auto h-full" />,
        ...
        },
        {
            ...
            image: <img src="/history/olympic-karate.jpg" alt="Olympic Karate 2020" className="w-auto h-full" />,
        ...
        },
        {
            ...
            image: <img src="/history/modern-dojo.jpg" alt="Modern Dojo" className="w-auto h-full" />,

...
const timelineEvents = [
    ...
    },
    {
        ...
        image: "/about/discovering-karate.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/first-competition.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/building-foundations.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/academic-growth.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/overcoming-challenges.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/academic-pursuits.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/academic-competitions.jpg",
        description:
    ...
    },
    {
        ...
        image: "/about/notable-performances.jpg",
        description:
    ...
    },
    {
        ...
        description:
            "My medals and awards mean far more to me than the victories they represent. Each one reflects the hard work, discipline, and determination I put in over the years. They remind me of the challenges I faced, the obstacles I overcame, and the countless hours I spent trying to improve. With every achievement, I didn’t just gain recognition—I grew as a person. I became more patient, resilient, and confident, learning important lessons about perseverance and dedication along the way. When I look at my collection today, I don’t just see accomplishments; I see my journey and how each endeavor helped shape who I am now."
                        ...
                        >
                            <div className={`about-card-inner ${index % 2 === 0 ? "about-card-inner-left" : "about-card-inner-right"}`}>
                                ...
                                <div className="about-card-photo">
                                    <img src={event.image} alt={event.title} className="w-full h-auto mx-auto"/>
                                </div>
                            </div>
                        </div>
                    ))}
